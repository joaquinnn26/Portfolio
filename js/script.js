...
btnDesarrollo.onclick=function(){
    ...
    img.innerHTML=`<img  src="./assets/images/Certificado-desarrolloWeb.jpeg" class="img" alt="Certificado">`
...
btnJavascript.onclick=function(){
    img=document.createElement("div")
    img.innerHTML=`<img  src="./assets/images/Certificado-Javascript.jpeg" class="img" alt="Certificado">`
    contentModal.appendChild(img)
...
btnBackend.onclick = function() {
        img=document.createElement("div")
    img.innerHTML=`<img  src="./assets/images/Certificado-backend.jpeg" class="img" alt="Certificado">`
    contentModal.appendChild(img)
